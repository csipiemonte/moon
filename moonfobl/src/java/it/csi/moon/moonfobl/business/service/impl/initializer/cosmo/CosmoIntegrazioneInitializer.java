...
package it.csi.moon.moonfobl.business.service.impl.initializer.cosmo;
...
import it.csi.moon.moonfobl.business.service.impl.initializer.DatiIntegrazioneInitializer;
...
public class CosmoIntegrazioneInitializer implements DatiIntegrazioneInitializer {

	@Autowired
	IstanzaDAO istanzaDAO;
	
	private static final String CLASS_NAME = "CosmoIntegrazioneInitializer";
	private static final Logger LOG = LoggerAccessor.getLoggerBusiness();
	
	public CosmoIntegrazioneInitializer() {
		super();
	...
	public String getDati(IntegrazioneInitParams initParams) throws BusinessException {
		try {
	    	...
	    	throw new BusinessException("ERROR Generica Initilizer CosmoIntegrazioneInitializer");
	    }
