...
import it.csi.moon.moonfobl.business.service.impl.dao.EpayNotificaPagamentoTestataDAO;
...
public class EpayNotificaPagamentoTestataDAOImpl extends JdbcTemplateDAO implements EpayNotificaPagamentoTestataDAO {
	...
	@Override
	public EpayNotificaPagamentoTestataEntity findById(Long idNotificaPagamTestata) {
		try {
