...
public interface CmdApi {
    ...
    @Path("/test-http")
    @Produces({ MediaType.TEXT_PLAIN })
    public Response testHttp(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders );
    
    @GET
    @Path("/test-https")
    @Produces({ MediaType.TEXT_PLAIN })
    public Response testHttpS(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders );
}
