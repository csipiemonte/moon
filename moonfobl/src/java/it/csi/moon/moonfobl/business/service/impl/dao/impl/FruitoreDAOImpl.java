...
public class FruitoreDAOImpl extends JdbcTemplateDAO implements FruitoreDAO {
	...
	private static final  String FIND_BY_ID_ENTE  = "SELECT fr.id_fruitore,fr.desc_fruitore " +
	...
	public Integer countByIdModulo(Long idModulo, Integer idFruitore) throws DAOException {
		...
		try {		
			...
			LOG.info("[" + CLASS_NAME + "::countByIdModulo] id_enidModulote: "+idModulo+"  id_fruitore: "+idFruitore+"  result: "+result);
		}
	}
