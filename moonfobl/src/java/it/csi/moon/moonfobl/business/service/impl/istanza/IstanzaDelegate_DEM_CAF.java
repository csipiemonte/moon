...
public class IstanzaDelegate_DEM_CAF extends IstanzaDefaultDelegate implements IstanzaServiceDelegate{
	
	private static final String CLASS_NAME = "IstanzaDelegate_DEM_CAF";
	private static final Logger LOG = LoggerAccessor.getLoggerBusiness();

	public IstanzaDelegate_DEM_CAF(){
		super();
...
//			throw new BusinessException("E' stata già inviata una istanza","404");				
			throw univocitaBEx;
		}		
