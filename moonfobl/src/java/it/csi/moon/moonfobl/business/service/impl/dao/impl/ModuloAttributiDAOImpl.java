...
/**
 * DAO per l'accesso ai attributi di un modulo NO CACHE
 * 
...
public class ModuloAttributiDAOImpl extends JdbcTemplateDAO implements ModuloAttributiDAO {
	...
	public List<ModuloAttributoEntity> findByIdModulo(Long idModulo) throws DAOException {
		try {
			...
			List<ModuloAttributoEntity> result = ( List<ModuloAttributoEntity>)  getCustomNamedParameterJdbcTemplateImpl().query(FIND_BY_ID_MODULO,
