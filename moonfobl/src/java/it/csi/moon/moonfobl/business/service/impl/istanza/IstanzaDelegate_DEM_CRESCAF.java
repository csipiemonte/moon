...
public class IstanzaDelegate_DEM_CRESCAF extends IstanzaDefaultDelegate implements IstanzaServiceDelegate{
	
	private static final String CLASS_NAME = "IstanzaDelegate_DEM_CRESCAF";
	private static final Logger LOG = LoggerAccessor.getLoggerBusiness();

	public IstanzaDelegate_DEM_CRESCAF(){
		super();
