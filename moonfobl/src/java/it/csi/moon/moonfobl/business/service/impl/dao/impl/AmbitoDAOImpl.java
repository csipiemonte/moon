...
public class AmbitoDAOImpl extends JdbcTemplateDAO implements AmbitoDAO {
	...
	private static final String SELECT_ = "SELECT id_ambito, codice_ambito, nome_ambito, id_visibilita_ambito, color, data_upd, attore_upd";
	private static final String SELECT_A_ = "SELECT a.id_ambito, a.codice_ambito, a.nome_ambito, a.id_visibilita_ambito, a.color, a.data_upd, a.attore_upd";
	
	private static final String FIND_BY_ID = SELECT_ + " FROM moon_fo_d_ambito WHERE id_ambito=:id_ambito";
	private static final String FIND_BY_CODICE = SELECT_ + " FROM  moon_fo_d_ambito WHERE codice_ambito = :codice_ambito";
	private static final String ELENCO = SELECT_ + " FROM moon_fo_d_ambito";
	private static final String FIND_BY_ID_MODULO = SELECT_A_
