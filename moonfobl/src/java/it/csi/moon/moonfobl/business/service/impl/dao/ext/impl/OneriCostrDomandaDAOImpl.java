 ...
 */
@Component
public class OneriCostrDomandaDAOImpl extends JdbcTemplateDAO implements OneriCostrDomandaDAO {
	private static final String CLASS_NAME= "OneriCostrDomandaDAOImpl";
	...
	private static final String UPDATE = "UPDATE moon_ext_oneri_costr_domanda\r\n" + 
			" SET id_istanza=:id_istanza, codice_istanza=:codice_istanza, codice_fiscale=:codice_fiscale, cognome=:cognome, nome=:nome, email=:email, cellulare=:cellulare, flag_dichiarante_beneficiario=:flag_dichiarante_beneficiario\r\n" + 
			", ben_tipologia_beneficiario=:ben_tipologia_beneficiario, ben_codice_fiscale=:ben_codice_fiscale, ben_cognome=:ben_cognome, ben_nome=:ben_nome, ben_ragione_sociale=:ben_ragione_sociale, ben_piva=:ben_piva, ben_data_fine_esercizio=:ben_data_fine_esercizio, ben_dimensione=ben_dimensione, ben_codice_ateco=:ben_codice_ateco, ben_forma_giuridica=:ben_forma_giuridica\r\n" + 
			", ben_sede_nazione=:ben_sede_nazione, ben_sede_regione=:ben_sede_regione, ben_sede_provincia=:ben_sede_provincia, ben_sede_comune=:ben_sede_comune, ben_sede_indirizzo=:ben_sede_indirizzo, ben_sede_cap=:ben_sede_cap\r\n" + 
			", prt_codice_provincia=:prt_codice_provincia, prt_nome_provincia=:prt_nome_provincia, prt_codice_comune=:prt_codice_comune, prt_nome_comune=:prt_nome_comune, prt_indirizzo=:prt_indirizzo, prt_cap=:prt_cap, prt_tipologia_titolo_edilizio=:prt_tipologia_titolo_edilizio, prt_data_presentazione=:prt_data_presentazione, prt_numero_pratica=:prt_numero_pratica\r\n" +
			", prt_tipologia_intervento=:prt_tipologia_intervento, prt_costo_presunto=:prt_costo_presunto, prt_importo_presunto=:prt_importo_presunto\r\n" + 
			", fo_codice_response=:fo_codice_response, bo_esito_controlli=:bo_esito_controlli, bo_operatore=:bo_operatore, bo_costo_validato=:bo_costo_validato, bo_importo_validato=:bo_importo_validato, bo_importo_pagato=:bo_importo_pagato\r\n" +
			", data_upd=now(), attore_upd=:attore_upd, data_invio_contabilia=:data_invio_contabilia\r\n" + 
			" WHERE id_ext_domanda=:id_ext_domanda";
	...
	/* Correzione conteggio pratica viene escusa le pratiche in stato RIFIUTATA 6
	...
	*/
	...
	private static final String CNT_BEN_CF = 	"select count(*) " +
												"from " +
												"moon_ext_oneri_costr_domanda meocd, " +
												"moon_wf_t_storico_workflow mwtsw, " +
												"moon_wf_d_stato mwds  " +
												"where meocd.id_istanza = mwtsw.id_istanza  " +
												"and mwds.id_stato_wf = mwtsw.id_stato_wf_arrivo " +
												"and mwtsw.data_fine is null " +
												"and meocd.ben_codice_fiscale = :ben_codice_fiscale " +
												"and mwds.id_stato_wf <> 6 " ;
	
	private static final String CNT_BEN_PIVA =  "select count(*) " +
												"from " +
												"moon_ext_oneri_costr_domanda meocd, " +
												"moon_wf_t_storico_workflow mwtsw, " +
												"moon_wf_d_stato mwds  " +
...
//	id_istanza, codice_istanza, id_modulo, codice_fiscale_dichiarante, id_stato_wf, data_creazione, attore_ins, attore_upd, fl_eliminata
    private MapSqlParameterSource mapEntityParameters(OneriCostrDomandaEntity entity) {
    	...
    	params.addValue("bo_operatore" , entity.getBoImportoValidato(), Types.VARCHAR);
