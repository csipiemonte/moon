...
public interface CurrentUserApi  {
    ...
    @GET
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "get current user", notes = "restituisce l'utente corrente", response = UserInfo.class, tags={ "MOOn", })
    ...
    public Response patchCurrentUser( UserChangeRequest userChangeRequest,
    	@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest, @Context HttpServletResponse httpResponse );
}
