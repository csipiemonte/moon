...
//		modulo.setIdVersioneModulo(moduloVersionato.getIdVersioneModulo());
		...
		modulo.setCategoria(CategoriaMapper.buildFromModuloVersionatoEntityForApi(moduloVersionato));
		return modulo;
	}
...
//		}
	...
	public static Modulo purgeForApi(Modulo modulo) {
		modulo.setIdModulo(null);
		modulo.setIdVersioneModulo(null);
		modulo.setIdModuloStruttura(null);
		modulo.setIdTipoCodiceIstanza(null);
		modulo.setDataIns(null);
		modulo.setDataUpd(null);
		modulo.setFlagIsRiservato(null);
		modulo.setFlagProtocolloIntegrato(null);
		modulo.setAttoreUpd(null);
		modulo.setTipoStruttura(null);
		modulo.setStruttura(null);
		if (modulo.getCategoria()!=null) {
			modulo.getCategoria().setIdCategoria(null);
		}
		return modulo;
	}
}
