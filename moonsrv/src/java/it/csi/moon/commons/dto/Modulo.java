...
public class Modulo   {
  // verra' utilizzata la seguente strategia serializzazione degli attributi: [implicit-camel-case] 
	 ...
	 * @param moduloToClone
	 */
	public Modulo(Modulo moduloToClone) {
		super();
		this.idVersioneModulo = moduloToClone.getIdVersioneModulo();
		this.idModulo = moduloToClone.getIdModulo();
		this.codiceModulo = moduloToClone.getCodiceModulo();
		this.versioneModulo = moduloToClone.getVersioneModulo();
		this.oggettoModulo = moduloToClone.getOggettoModulo();
		this.descrizioneModulo = moduloToClone.getDescrizioneModulo();
	}
	...
	@Override
	  ...
	  @Override
	  public int hashCode() {
	    return Objects.hash(idVersioneModulo, idModulo, codiceModulo, versioneModulo, oggettoModulo, descrizioneModulo, dataIns, dataUpd, flagIsRiservato, idTipoCodiceIstanza, flagProtocolloIntegrato, attoreUpd, idModuloStruttura, tipoStruttura, struttura, stato, attributi, portali, processo);
	  }
