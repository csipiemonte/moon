...
public class WorkflowFilter {
	...
	private boolean mostraContenutoAzione;
	...
	public boolean isMostraContenutoAzione() {
		return mostraContenutoAzione;
	}
	public void setMostraContenutoAzione(boolean mostraContenutoAzione) {
		this.mostraContenutoAzione = mostraContenutoAzione;
	}
	...
	public static class Builder {
		...
		private boolean _mostraContenutoAzione; // fa riferimento al campo id_gruppoUtentiDestinatari =4
		...
		public Builder mostraContenutoAzione(boolean mostraContenutoAzione) {
			this._mostraContenutoAzione = mostraContenutoAzione;
			return this;
		}
	...
	private WorkflowFilter(Builder builder) {
		...
		setMostraContenutoAzione(builder._mostraContenutoAzione);
	}
	...
	public String toString() {
		return "WorkflowFilter [idProcesso=" + idProcesso + ", idModulo=" + idModulo + ", idStatoWfPartenza="
				...
				+ escludiAzioniDiSistema + ", isAutomatica=" +isAutomatica 
				+ ", isMostraContenutoAzione=" +mostraContenutoAzione + "]";
	}
