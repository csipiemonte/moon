...
public class ModuliFilter {
	...
	public Optional<String> getCodiceAmbito() {
		return Optional.ofNullable(codiceAmbito);
	}
	...
	public Optional<Integer> getIdFruitore() {
		return Optional.ofNullable(idFruitore);
	}
	...
	public static class Builder {
		...
		private String _codiceArea;
		private Integer _idAmbito;
		private String _codiceAmbito;
		private Integer _idVisibilitaAmbito;
		private Integer _idFruitore;
		...
		public Builder codiceEnte(String codiceEnte) {
		...
		public Builder codiceArea(String codiceArea) {
			this._codiceArea = codiceArea;
			return this;
		}
		...
		public Builder codiceAmbito(String codiceAmbito) {
			this._codiceAmbito = codiceAmbito;
			return this;
		}
		...
		public Builder idFruitore(Integer idFruitore) {
			this._idFruitore = idFruitore;
			return this;
		}
	...
	public ModuliFilter(Builder builder) {
		 ...
		 setCodiceEnte(builder._codiceEnte);
		 setIdArea(builder._idArea);
		 setCodiceArea(builder._codiceArea);
		 setIdAmbito(builder._idAmbito);
		 setCodiceAmbito(builder._codiceAmbito);
		 setIdVisibilitaAmbito(builder._idVisibilitaAmbito);
		 setIdFruitore(builder._idFruitore);
	}
	...
	public String toString() {
		return "ModuliFilter [idModulo=" + idModulo + ", idVersioneModulo=" + idVersioneModulo + ", codiceModulo="
				...
				+ ", codiceEnte=" + codiceEnte + ", codiceArea=" + codiceArea + ", codiceAmbito=" + codiceAmbito
				+ ", idVisibilitaAmbito=" + idVisibilitaAmbito + ", idFruitore=" + idFruitore
