...
/**
 * Entity della tabella degli attributi di configurazione per la pubblicazione su MyDocs (DOCME)
 * <br>
 * <br>Tabella moon_md_d_parametri
 * <br>PK: idParametro
 * 
 ...
 */
public class MyDocsParametroEntity {
	...
	public MyDocsParametroEntity() {
		super();
	}

	public MyDocsParametroEntity(Long idParametro, Long idEnte, Long idArea, Long idModulo, String nomeAttributo, String valore, Date dataUpd,
			String attoreUpd) {
		super();
