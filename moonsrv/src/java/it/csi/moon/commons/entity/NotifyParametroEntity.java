...
/**
 * Entity della tabella degli attributi di configurazione del NOTIFICATORE
 * <br>
 * <br>Tabella moon_ntf_d_parametri
 * <br>PK: idParametro
 * 
 * @author SC
 * 
 ...
 */
public class NotifyParametroEntity {
	...
	public NotifyParametroEntity() {
		super();
	}

	public NotifyParametroEntity(Long idParametro, Long idEnte, Long idArea, Long idModulo, String nomeAttributo, String valore, Date dataUpd,
			String attoreUpd) {
		super();
