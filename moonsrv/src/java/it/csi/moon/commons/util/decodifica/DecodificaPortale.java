...
public enum DecodificaPortale implements DecodificaMOON {
	...
	// CITTA FACILE
	PAVIA_CITTA_FACILE_201(201L,"PAVIA_CITTA_FACILE", "servizi-pavia.portali.csi.it", "", 201L),
	NOVARA_CITTA_FACILE_202(202L,"NOVARA_CITTA_FACILE", "servizi-novara.portali.csi.it", "", 202L),
	PINEROLO_CITTA_FACILE_203(203L,"PINEROLO_CITTA_FACILE", "servizi-pinerolo.portali.csi.it", "", 203L),
	ALESSANDRIA_CITTA_FACILE_204(204L,"ALESSANDRIA_CITTA_FACILE", "servizi-alessandria.portali.csi.it", "", 204L),
	// SERIZI SRV BO
...
//	public static DecodificaPortale byIdPortale(Integer idPortale) {
//		for(DecodificaPortale d : values()) {
