...
/**
 * Mappa degli attributi di configurazione del protocollo
 * 
 ...
 *
 */
public class MapProtocolloAttributi {

	public static Map<String, Object> EMPTY_MAP = new HashMap<>();
	private Map<String, Object> attributiMap = new HashMap<>();

	public MapProtocolloAttributi() {
		super();
	}
	public MapProtocolloAttributi(List<ProtocolloParametroEntity> listAttributi) {
		super();
		if (listAttributi != null && !listAttributi.isEmpty()) {	
			listAttributi.forEach( mae -> {
				ProtocolloAttributoKeys key = ProtocolloAttributoKeys.byName(mae.getNomeAttributo());
	...
	public String toString() {
		...
		sb.append("MapProtocolloAttributi [\n");
