...
public class ReportMapper_TARI_UND_RECL extends BaseReportMapper_TARI implements ReportMapper {
	
	private final static String CLASS_NAME = "ReportMapper_TARI_UND_RECL";
	
	public ReportMapper_TARI_UND_RECL(String codiceEstrazione) {
