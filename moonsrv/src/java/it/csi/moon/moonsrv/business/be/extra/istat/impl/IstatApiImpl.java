...
package it.csi.moon.moonsrv.business.be.extra.istat.impl;
...
import it.csi.moon.moonsrv.business.be.extra.istat.IstatApi;
...
import it.csi.moon.moonsrv.business.service.impl.dao.extra.istat.ProvinciaDAO;
import it.csi.moon.moonsrv.business.service.impl.dao.extra.istat.RegioneDAO;
...
public class IstatApiImpl extends MoonBaseApiImpl implements IstatApi {
	...
	@Autowired
	AnprNazioneService anprNazioneService; // Stati esteri di provenienza dati ANPR ma basati sucodice ISTAT
	@Autowired
	@Qualifier("moon")
	...
	public Response getNazioneById(String codice, String fields,
		...
		try {
			...
			LOG.error("[" + CLASS_NAME + "::getNazioneById] UnprocessableEntityException");
			throw uee;
		} catch (Exception ex) {
    ...
    public Response getProvinceByRegione(String codiceRegione, String fields,
		...
		try {
			...
			throw new ServiceException("Errore generico servizio elenco ProvinceByRegione");
		} 
	}
    ...
    public Response getProvinciaBySigla( String siglaProvincia, String fields,
		...
		try {
			...
			LOG.error("[" + CLASS_NAME + "::getProvinciaBySigla] UnprocessableEntityException");
			throw uee;
		} catch (Exception ex) {
    ...
    public Response getComuneByProvincia( String codiceProvincia, String codiceComune, String fields,
		...
		try {
			...
			LOG.error("[" + CLASS_NAME + "::getComuneByProvincia] UnprocessableEntityException");
			throw uee;
		} catch (Exception ex) {
	...
	public Response getCodiceAteco(String codiceAteco, 
		...
		try {
			codiceAtecoForSearch = validaCodiceAtecoRequired(codiceAteco);
	...
	protected String validaCodiceAtecoRequired(String codiceAteco) {
