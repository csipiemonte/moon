...
public class ComuneDAOMock implements ComuneDAO {
	...
	public Comune findByPK(Integer codiceComune) {
		for (Entry<Integer, ArrayList<Comune>> entryProvincia : mappaComuniPerProvincia.entrySet()) {
			for (Comune comune : mappaComuniPerProvincia.get(entryProvincia.getKey())) {
	...
	public void init() {
		 ...
		 * PIEMONTE
		 */
		ArrayList<Comune> listaComuni2 = new ArrayList<>(); // ALESSANDRIA
		ArrayList<Comune> listaComuni6 = new ArrayList<>(); // ASTI
		ArrayList<Comune> listaComuni12 = new ArrayList<>(); // BIELLA
		ArrayList<Comune> listaComuni28 = new ArrayList<>(); // CUNEO
		ArrayList<Comune> listaComuni57 = new ArrayList<>(); // NOVARA
		ArrayList<Comune> listaComuni91 = new ArrayList<>(); // TORINO
		ArrayList<Comune> listaComuni100 = new ArrayList<>(); // VERBANO-CUSIO-OSSOLA
		ArrayList<Comune> listaComuni101 = new ArrayList<>(); // VERCELLI


		/* 
		 * VALLE D'AOSTA
		 */
		ArrayList<Comune> listaComuni97 = new ArrayList<>(); // VALLE D'AOSTA


		/* 
		 * LOMBARDIA
		 */
		ArrayList<Comune> listaComuni11 = new ArrayList<>(); // BERGAMO
		ArrayList<Comune> listaComuni15 = new ArrayList<>(); // BRESCIA
		ArrayList<Comune> listaComuni24 = new ArrayList<>(); // COMO
		ArrayList<Comune> listaComuni26 = new ArrayList<>(); // CREMONA
		ArrayList<Comune> listaComuni45 = new ArrayList<>(); // LECCO
		ArrayList<Comune> listaComuni47 = new ArrayList<>(); // LODI
		ArrayList<Comune> listaComuni50 = new ArrayList<>(); // MANTOVA
		ArrayList<Comune> listaComuni54 = new ArrayList<>(); // MILANO
		ArrayList<Comune> listaComuni63 = new ArrayList<>(); // PAVIA
		ArrayList<Comune> listaComuni87 = new ArrayList<>(); // SONDRIO
		ArrayList<Comune> listaComuni98 = new ArrayList<>(); // VARESE


		/* 
		 * TRENTINO ALTO ADIGE
		 */
		ArrayList<Comune> listaComuni14 = new ArrayList<>(); // BOLZANO - BOZEN
		ArrayList<Comune> listaComuni93 = new ArrayList<>(); // TRENTO


		/* 
		 * VENETO
		 */
		ArrayList<Comune> listaComuni9 = new ArrayList<>(); // BELLUNO
		ArrayList<Comune> listaComuni60 = new ArrayList<>(); // PADOVA
		ArrayList<Comune> listaComuni81 = new ArrayList<>(); // ROVIGO
		ArrayList<Comune> listaComuni94 = new ArrayList<>(); // TREVISO
		ArrayList<Comune> listaComuni99 = new ArrayList<>(); // VENEZIA
		ArrayList<Comune> listaComuni102 = new ArrayList<>(); // VERONA
		ArrayList<Comune> listaComuni104 = new ArrayList<>(); // VICENZA


		/* 
		 * FRIULI VENEZIA GIULIA
		 */
		ArrayList<Comune> listaComuni37 = new ArrayList<>(); // GORIZIA
		ArrayList<Comune> listaComuni71 = new ArrayList<>(); // PORDENONE
		ArrayList<Comune> listaComuni95 = new ArrayList<>(); // TRIESTE
		ArrayList<Comune> listaComuni96 = new ArrayList<>(); // UDINE


		/* 
		 * LIGURIA
		 */
		ArrayList<Comune> listaComuni36 = new ArrayList<>(); // GENOVA
		ArrayList<Comune> listaComuni39 = new ArrayList<>(); // IMPERIA
		ArrayList<Comune> listaComuni41 = new ArrayList<>(); // LA SPEZIA
		ArrayList<Comune> listaComuni84 = new ArrayList<>(); // SAVONA


		/* 
		 * EMILIA ROMAGNA
		 */
		ArrayList<Comune> listaComuni13 = new ArrayList<>(); // BOLOGNA
		ArrayList<Comune> listaComuni30 = new ArrayList<>(); // FERRARA
		ArrayList<Comune> listaComuni34 = new ArrayList<>(); // FORLI'-CESENA
		ArrayList<Comune> listaComuni55 = new ArrayList<>(); // MODENA
		ArrayList<Comune> listaComuni62 = new ArrayList<>(); // PARMA
		ArrayList<Comune> listaComuni67 = new ArrayList<>(); // PIACENZA
		ArrayList<Comune> listaComuni75 = new ArrayList<>(); // RAVENNA
		ArrayList<Comune> listaComuni77 = new ArrayList<>(); // REGGIO NELL'EMILIA
		ArrayList<Comune> listaComuni79 = new ArrayList<>(); // RIMINI


		/* 
		 * TOSCANA
		 */
		ArrayList<Comune> listaComuni4 = new ArrayList<>(); // AREZZO
		ArrayList<Comune> listaComuni31 = new ArrayList<>(); // FIRENZE
		ArrayList<Comune> listaComuni38 = new ArrayList<>(); // GROSSETO
		ArrayList<Comune> listaComuni46 = new ArrayList<>(); // LIVORNO
		ArrayList<Comune> listaComuni48 = new ArrayList<>(); // LUCCA
		ArrayList<Comune> listaComuni51 = new ArrayList<>(); // MASSA-CARRARA
		ArrayList<Comune> listaComuni68 = new ArrayList<>(); // PISA
		ArrayList<Comune> listaComuni69 = new ArrayList<>(); // PISTOIA
		ArrayList<Comune> listaComuni73 = new ArrayList<>(); // PRATO
		ArrayList<Comune> listaComuni85 = new ArrayList<>(); // SIENA


		/* 
		 * UMBRIA
		 */
		ArrayList<Comune> listaComuni64 = new ArrayList<>(); // PERUGIA
		ArrayList<Comune> listaComuni90 = new ArrayList<>(); // TERNI


		/* 
		 * MARCHE
		 */
		ArrayList<Comune> listaComuni3 = new ArrayList<>(); // ANCONA
		ArrayList<Comune> listaComuni5 = new ArrayList<>(); // ASCOLI PICENO
		ArrayList<Comune> listaComuni49 = new ArrayList<>(); // MACERATA
		ArrayList<Comune> listaComuni65 = new ArrayList<>(); // PESARO E URBINO


		/* 
		 * LAZIO
		 */
		ArrayList<Comune> listaComuni35 = new ArrayList<>(); // FROSINONE
		ArrayList<Comune> listaComuni43 = new ArrayList<>(); // LATINA
		ArrayList<Comune> listaComuni78 = new ArrayList<>(); // RIETI
		ArrayList<Comune> listaComuni80 = new ArrayList<>(); // ROMA
		ArrayList<Comune> listaComuni105 = new ArrayList<>(); // VITERBO


		/* 
		 * ABRUZZO
		 */
		ArrayList<Comune> listaComuni23 = new ArrayList<>(); // CHIETI
		ArrayList<Comune> listaComuni42 = new ArrayList<>(); // L'AQUILA
		ArrayList<Comune> listaComuni66 = new ArrayList<>(); // PESCARA
		ArrayList<Comune> listaComuni89 = new ArrayList<>(); // TERAMO


		/* 
		 * MOLISE
		 */
		ArrayList<Comune> listaComuni19 = new ArrayList<>(); // CAMPOBASSO
		ArrayList<Comune> listaComuni40 = new ArrayList<>(); // ISERNIA


		/* 
		 * CAMPANIA
		 */
		ArrayList<Comune> listaComuni7 = new ArrayList<>(); // AVELLINO
		ArrayList<Comune> listaComuni10 = new ArrayList<>(); // BENEVENTO
		ArrayList<Comune> listaComuni20 = new ArrayList<>(); // CASERTA
		ArrayList<Comune> listaComuni56 = new ArrayList<>(); // NAPOLI
		ArrayList<Comune> listaComuni82 = new ArrayList<>(); // SALERNO


		/* 
		 * PUGLIA
		 */
		ArrayList<Comune> listaComuni8 = new ArrayList<>(); // BARI
		ArrayList<Comune> listaComuni16 = new ArrayList<>(); // BRINDISI
		ArrayList<Comune> listaComuni33 = new ArrayList<>(); // FOGGIA
		ArrayList<Comune> listaComuni44 = new ArrayList<>(); // LECCE
		ArrayList<Comune> listaComuni88 = new ArrayList<>(); // TARANTO


		/* 
		 * BASILICATA
		 */
		ArrayList<Comune> listaComuni52 = new ArrayList<>(); // MATERA
		ArrayList<Comune> listaComuni72 = new ArrayList<>(); // POTENZA


		/* 
		 * CALABRIA
		 */
		ArrayList<Comune> listaComuni22 = new ArrayList<>(); // CATANZARO
		ArrayList<Comune> listaComuni25 = new ArrayList<>(); // COSENZA
		ArrayList<Comune> listaComuni27 = new ArrayList<>(); // CROTONE
		ArrayList<Comune> listaComuni76 = new ArrayList<>(); // REGGIO DI CALABRIA
		ArrayList<Comune> listaComuni103 = new ArrayList<>(); // VIBO VALENTIA


		/* 
		 * SICILIA
		 */
		ArrayList<Comune> listaComuni1 = new ArrayList<>(); // AGRIGENTO
		ArrayList<Comune> listaComuni18 = new ArrayList<>(); // CALTANISSETTA
		ArrayList<Comune> listaComuni21 = new ArrayList<>(); // CATANIA
		ArrayList<Comune> listaComuni29 = new ArrayList<>(); // ENNA
		ArrayList<Comune> listaComuni53 = new ArrayList<>(); // MESSINA
		ArrayList<Comune> listaComuni61 = new ArrayList<>(); // PALERMO
		ArrayList<Comune> listaComuni74 = new ArrayList<>(); // RAGUSA
		ArrayList<Comune> listaComuni86 = new ArrayList<>(); // SIRACUSA
		ArrayList<Comune> listaComuni92 = new ArrayList<>(); // TRAPANI


		/* 
		 * SARDEGNA
		 */
		ArrayList<Comune> listaComuni17 = new ArrayList<>(); // CAGLIARI
		ArrayList<Comune> listaComuni58 = new ArrayList<>(); // NUORO
		ArrayList<Comune> listaComuni59 = new ArrayList<>(); // ORISTANO
		ArrayList<Comune> listaComuni83 = new ArrayList<>(); // SASSARI
	...
	@Override
	public String findEmailAslByCodiceComune(Integer codiceComune) {
