...
/*
		...
		// 2. PRESENTAZIONE
		final String SEPARATOR = ".";
		StringBuilder sb = new StringBuilder().append(moduloE.getCodiceModulo()).append(SEPARATOR);
		switch (moduloE.getIdTipoCodiceIstanza()) {
			case 1: // Tipo1: codice_modulo.versione.anno.prog
				sb.append(moduloE.getVersioneModulo()).append(SEPARATOR);
				sb.append(year).append(SEPARATOR).append(padProgressivo(progressivoE));
				break;
			case 2: // Tipo2: codice_modulo.versione.anno.prog_annuale
				sb.append(moduloE.getVersioneModulo()).append(SEPARATOR);
				sb.append(year).append(SEPARATOR).append(padProgressivo(progressivoE));
				break;
			case 3: // Tipo3: codice_modulo.versione.str8
				sb.append(moduloE.getVersioneModulo()).append(SEPARATOR);
				sb.append(padProgressivo(progressivoE));
				break;
			case 4: // Tipo4: codice_modulo.str8
				sb.append(padProgressivo(progressivoE));
				break;
		}
