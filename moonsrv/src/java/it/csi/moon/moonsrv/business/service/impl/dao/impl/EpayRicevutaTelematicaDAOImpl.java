...
public class EpayRicevutaTelematicaDAOImpl extends JdbcTemplateDAO implements EpayRicevutaTelematicaDAO {
	...
	public EpayRicevutaTelematicaEntity findById(Long idRicevutaTelematica) throws ItemNotFoundDAOException, DAOException {
		try {
			...
			throw new DAOException("ERRORE FIND_ID EPAY RT", "MOONSRV-30800");
		}
	}
	...
	public List<EpayRicevutaTelematicaEntity> findByIdTestata(Long idTestata) throws DAOException {
		try {
			...
			LOG.error("[" + CLASS_NAME + "::findById] Errore database: " + e.getMessage(), e);
			throw new DAOException("ERRORE FIND_BY_ID_TESTATA EPAY RT", "MOONSRV-30800");
		}
	}
	...
	public Long insert(EpayRicevutaTelematicaEntity entity) throws DAOException {
		try {
			...
			throw new DAOException("ERRORE INSERT EPAY RT", "MOONSRV-30800");
		}
	}
	...
	public int update(EpayRicevutaTelematicaEntity entity) throws DAOException {
		try {
			...
			throw new DAOException("ERRORE AGGIORNAMENTO EPAY RT", "MOONSRV-30800");
		}
	}
