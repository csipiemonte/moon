...
import it.csi.moon.moonsrv.business.service.impl.dao.ArchiviaDoquiParametroDAO;
import it.csi.moon.moonsrv.exceptions.business.DAOException;
import it.csi.moon.moonsrv.exceptions.business.ItemNotFoundDAOException;

/**
 * DAO per l'accesso ai parametri per il recupero dell'archiviazione su DOQUI
 * <br>
 * <br>Tabella principale : moon_prar_d_parametri
 * 
 * @see ProtocolloParametroEntity
 * 
 * @author Alberto
 * 
 * @version 1.0.0 - 07/04/2022 - versione iniziale
 */
@Component
public class ArchiviaDoquiParametroDAOImpl extends JdbcTemplateDAO implements ArchiviaDoquiParametroDAO {
	private static final String CLASS_NAME = "ArchiviaDoquiParametroDAOImpl";
	...
	private static final String FIND_BY_ID = SELECT_FILEDS +
			" FROM moon_prar_d_parametri WHERE id_parametro = :id_parametro";
	
	private static final String FIND_FOR_MODULO = SELECT_FILEDS + " FROM (\n" + 
			" select 1 priority, * \n" + 
			" FROM moon_prar_d_parametri\n" + 
	...
	private static final  String INSERT = "INSERT INTO moon_prar_d_parametri (id_parametro, id_ente, id_area, id_modulo, nome_attributo, valore, data_upd, attore_upd)" + 
			" VALUES (:id_parametro, :id_ente, :id_area, :id_modulo, :nome_attributo, :valore, :data_upd, :attore_upd)";

	private static final  String UPDATE = "UPDATE moon_prar_d_parametri" +
	...
	private static final String DELETE = "DELETE FROM moon_prar_d_parametri WHERE id_parametro = :id_parametro";
		
	private static final String SEQ_ID = "SELECT nextval('moon_prar_d_parametri_id_parametro_seq')";
