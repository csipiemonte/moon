...
public class PortaleDAOImpl extends JdbcTemplateDAO implements PortaleDAO {
	...
	private static final String FIND_SELECT_FIELDS_P = "SELECT p.id_portale, p.codice_portale, p.nome_portale, p.descrizione_portale, p.fl_attivo, p.data_upd, p.attore_upd";
