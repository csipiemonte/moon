...
public class ProtocolloRichiestaDAOImpl extends JdbcTemplateDAO implements ProtocolloRichiestaDAO {
	...
	private static final String FIND_SELECT_FIELDS = "SELECT id_richiesta, data_richiesta, codice_richiesta, uuid_richiesta, stato, tipo_ing_usc, tipo_doc, id_istanza, id_allegato_istanza,  id_file, id_modulo, id_area, id_ente, id_protocollatore, uuid_protocollatore, note, codice_esito, desc_esito, data_upd, id_storico_workflow\n";
	...
	private static final  String INSERT = "INSERT INTO moon_pr_t_richiesta (id_richiesta, data_richiesta, codice_richiesta, uuid_richiesta, stato, tipo_ing_usc, tipo_doc, id_istanza, id_allegato_istanza, id_file, id_modulo, id_area, id_ente, id_protocollatore, uuid_protocollatore, note, codice_esito, desc_esito, data_upd, id_storico_workflow)" + 
			" VALUES (:id_richiesta, :data_richiesta, :codice_richiesta, :uuid_richiesta, :stato, :tipo_ing_usc, :tipo_doc, :id_istanza, :id_allegato_istanza,  :id_file, :id_modulo, :id_area, :id_ente, :id_protocollatore, :uuid_protocollatore, :note, :codice_esito, :desc_esito, :data_upd, :id_storico_workflow)";

	private static final  String UPDATE_ESITO_FIELDS = "UPDATE moon_pr_t_richiesta" +
