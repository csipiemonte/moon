...
import it.csi.moon.moonsrv.business.be.EntiApi;
	...
	public Response getEnti(String idEnteQP, String codiceEnteQP, String nomeEnteQP,
		...
		try {
			if (LOG.isDebugEnabled()) {
				...
				LOG.debug("[" + CLASS_NAME + "::getEnti] IN utenteAbilitato: "+utenteAbilitatoQP);
			}
			...
			filter.setNomePortale(nomePortaleQP);
			filter.setIdPortale(validaLong(idPortaleQP));
			filter.setUtenteAbilitato(utenteAbilitatoQP);
			LOG.debug("[" + CLASS_NAME + "::getEnti] BEGIN");
