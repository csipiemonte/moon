 ...
 * @since 1.0.0
 */
public class ApimanRSTemplateImpl extends ApiRestTemplateImpl {
	
	private static final String CLASS_NAME = "ApimanRSTemplateImpl";
	protected static final String MSG_ERR_DEFAULT = "ERRORE CHIAMATA API MANAGER CSI ";

	/* Parametri di identificazione della componente MOON su API Manager CSI */
     ...
     */
    public ApimanRSTemplateImpl() {
    	setEndpoint(EnvProperties.readFromFile(EnvProperties.APIMAN_ENDPOINT));
    }
	...
	protected String getConsumerKey() {
		return EnvProperties.readFromFile(useSandbox()?EnvProperties.APIMAN_SANDBOX_CONSUMERKEY:EnvProperties.APIMAN_PROD_CONSUMERKEY);
//		return EnvProperties.readFromFile((getConsumerPrefix()==null?"":getConsumerPrefix())+EnvProperties.APIMINT_CONSUMERKEY);
	}
    protected String getConsumerSecret() {
		return EnvProperties.readFromFile(useSandbox()?EnvProperties.APIMAN_SANDBOX_CONSUMERSECRET:EnvProperties.APIMAN_PROD_CONSUMERSECRET);
