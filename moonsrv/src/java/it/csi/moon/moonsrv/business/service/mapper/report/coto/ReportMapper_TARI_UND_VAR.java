...
public class ReportMapper_TARI_UND_VAR extends BaseReportMapper_TARI implements ReportMapper {
	
	private final static String CLASS_NAME = "ReportMapper_TARI_UND_VAR";
	
	public ReportMapper_TARI_UND_VAR(String codiceEstrazione) {
