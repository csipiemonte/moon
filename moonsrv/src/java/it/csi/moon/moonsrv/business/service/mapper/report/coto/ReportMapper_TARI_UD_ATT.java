...
public class ReportMapper_TARI_UD_ATT extends BaseReportMapper_TARI implements ReportMapper {
	
	private final static String CLASS_NAME = "ReportMapper_TARI_UD_ATT";

	public ReportMapper_TARI_UD_ATT(String codiceEstrazione) {
