...
public class FruitoreDatiAzioneDAOImpl extends JdbcTemplateDAO implements FruitoreDatiAzioneDAO {
	...
	private static final  String FIND_BY_ID  = "SELECT id_fruitore_dati_azione, codice, descrizione, identificativo, data, numero_protocollo, data_protocollo, id_istanza, id_storico_workflow" +
			" FROM moon_wf_t_fruitore_dati_azione" +
			" WHERE id_fruitore_dati_azione = :id_fruitore_dati_azione";
	
	private static final  String FIND_BY_ID_STORICO_WORFLOW  = "SELECT id_fruitore_dati_azione, codice, descrizione, identificativo, data, numero_protocollo, data_protocollo, id_istanza, id_storico_workflow" +
			" FROM moon_wf_t_fruitore_dati_azione" +
