...
public class ReportMapper_TARI_NOAUT extends BaseReportMapper_TARI implements ReportMapper {
	
	private final static String CLASS_NAME = "ReportMapper_TARI_NOAUT";

	public ReportMapper_TARI_NOAUT(String codiceEstrazione) {
	...
	public String remapIstanza(IstanzaReport istanza) throws Exception {
		...
		String canale = EXPORT_VAL.CANALE_COMUNICAZIONE_AUT_WEB_NO_AUT;
