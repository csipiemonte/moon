...
@Path("/extra/demografia")
@Produces({ "application/json" })
public interface DemografiaApi  {
    ...
    @GET
    @Path("/orchanpr/famigliaByCF/{codiceFiscale}")
    @Produces({ "application/json" })
    ...
    @io.swagger.annotations.ApiResponse(code = 200, message = "errore generico", response = Error.class) })
    public Response getFamigliaANPR( @PathParam("codiceFiscale") String codiceFiscale, @QueryParam("fields") String fields, @QueryParam("ipAdress") String ipAdress, @QueryParam("utente") String utente,
    	@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
