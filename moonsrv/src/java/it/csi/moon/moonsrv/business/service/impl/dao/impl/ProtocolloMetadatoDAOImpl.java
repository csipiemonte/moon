...
import it.csi.moon.moonsrv.business.service.impl.dao.ProtocolloMetadatoDAO;
...
public class ProtocolloMetadatoDAOImpl extends JdbcTemplateDAO implements ProtocolloMetadatoDAO {
	...
	private static final String SELECT_FILEDS = "SELECT id_metadato, nome_metadato, default_value, ordine ";
	private static final String FIND_BY_ID = SELECT_FILEDS +
			" FROM moon_pr_d_metadato WHERE id_metadato = :id_metadato";
	
	private static final String FIND_ALL = SELECT_FILEDS
