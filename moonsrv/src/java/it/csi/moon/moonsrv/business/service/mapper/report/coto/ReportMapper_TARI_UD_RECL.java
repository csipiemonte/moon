...
public class ReportMapper_TARI_UD_RECL extends BaseReportMapper_TARI implements ReportMapper {
	
	private final static String CLASS_NAME = "ReportMapper_TARI_UD_RECL";

	public ReportMapper_TARI_UD_RECL(String codiceEstrazione) {
	...
	public String remapIstanza(IstanzaReport istanza) throws Exception {
		...
		//Tipologia Richiesta
		String tipologiaRichiesta = EXPORT_VAL.TIP_RECLAMI;
