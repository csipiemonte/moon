...
import it.csi.moon.moonsrv.business.service.impl.dao.TipoCodiceIstanzaDAO;
...
public class TipoCodiceIstanzaDAOImpl extends JdbcTemplateDAO implements TipoCodiceIstanzaDAO {
	...
	private static final String SELECT_FROM = "SELECT id_tipo_codice_istanza, desc_codice, descrizione_tipo FROM moon_io_d_tipocodiceistanza";
	private static final String FIND_BY_ID = SELECT_FROM + " WHERE id_tipo_codice_istanza = :id_tipo_codice_istanza";
	private static final String FIND_BY_CODICE = SELECT_FROM + " WHERE desc_codice = :desc_codice";
	private static final String ELENCO = SELECT_FROM;
