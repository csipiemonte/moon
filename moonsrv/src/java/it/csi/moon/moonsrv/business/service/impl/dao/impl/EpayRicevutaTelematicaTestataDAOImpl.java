...
public class EpayRicevutaTelematicaTestataDAOImpl extends JdbcTemplateDAO implements EpayRicevutaTelematicaTestataDAO {
	...
	public EpayRicevutaTelematicaTestataEntity findById(Long idRicevutaTelematica) throws ItemNotFoundDAOException, DAOException {
		try {
			...
			throw new DAOException("ERRORE FIND_ID EPAY RTT", "MOONSRV-30800");
		}
	}
	...
	public Long insert(EpayRicevutaTelematicaTestataEntity entity) throws DAOException {
		try {
			...
			throw new DAOException("ERRORE INSERT EPAY RTT", "MOONSRV-30800");
		}
	}
	...
	public int update(EpayRicevutaTelematicaTestataEntity entity) throws DAOException {
		try {
			...
			throw new DAOException("ERRORE AGGIORNAMENTO EPAY RTT", "MOONSRV-30800");
		}
	}
