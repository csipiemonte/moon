...
import it.csi.moon.moonsrv.business.service.impl.dao.MessaggioSupportoDAO;
...
public class MessaggioSupportoDAOImpl extends JdbcTemplateDAO implements MessaggioSupportoDAO {
	...
	private static final String SELECT_FIELDS = "SELECT id_messaggio_supporto, id_richiesta_supporto, contenuto, provenienza, data_ins, attore_ins"; 
	private static final String FROM_MOON_FO_T_MESSAGGIO_SUPPORTO = " FROM moon_fo_t_messaggio_supporto";
	private static final String ID_MESSAGGIO_SUPPORTO = "id_messaggio_supporto";
	
	private static final String FIND_BY_ID = SELECT_FIELDS +
			FROM_MOON_FO_T_MESSAGGIO_SUPPORTO +
			" WHERE id_messaggio_supporto = :id_messaggio_supporto";

	private static final String FIND_BY_ID_RICHESTA = SELECT_FIELDS +
			FROM_MOON_FO_T_MESSAGGIO_SUPPORTO +
