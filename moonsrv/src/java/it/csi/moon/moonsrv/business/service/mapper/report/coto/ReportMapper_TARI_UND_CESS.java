...
public class ReportMapper_TARI_UND_CESS extends BaseReportMapper_TARI implements ReportMapper {
	
	private final static String CLASS_NAME = "ReportMapper_TARI_UND_CESS";

	public ReportMapper_TARI_UND_CESS(String codiceEstrazione) {
