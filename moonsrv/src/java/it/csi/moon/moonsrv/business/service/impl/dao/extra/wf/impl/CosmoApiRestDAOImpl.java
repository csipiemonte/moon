...
@Qualifier("applogic")
@Component
public class CosmoApiRestDAOImpl extends ApiRestTemplateImpl implements CosmoDAO {
	
	private static final String CLASS_NAME = "CosmoApiRestDAOImpl";
	
    public CosmoApiRestDAOImpl() {
    	super();
    	setEndpoint(EnvProperties.readFromFile(EnvProperties.WF_COSMO_APPLOGIC_ENDPOINT));
	...
	public String getUsername() {
		return EnvProperties.readFromFile(EnvProperties.WF_COSMO_APPLOGIC_USERNAME);
	}
    @Override
	public String getPassword() {
		return EnvProperties.readFromFile(EnvProperties.WF_COSMO_APPLOGIC_PASSWORD);
	}
	...
	public EsitoCreazioneDocumentiFruitore creaDocumento(CreaDocumentiFruitoreRequest documento) throws DAOException {
        ...
        try {
            ...
            float sec = (end - start); 
            LOG.info("creaDocumento() in " + sec + " milliseconds.");
            LOG.debug("[" + CLASS_NAME + "::creaDocumento] END");
        }
	}
	...
	public byte[] getContenuto(String idPratica) throws DAOException {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            float sec = (end - start); 
            LOG.info("getContenuto() in " + sec + " milliseconds.");
            LOG.debug("[" + CLASS_NAME + "::getContenuto] END");
        }
	}
	//
	// Pratiche
	...
	public GetPraticaFruitoreResponse getPratica(String idPratica) throws DAOException {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            float sec = (end - start); 
            LOG.info("getPratica() in " + sec + " milliseconds.");
            LOG.debug("[" + CLASS_NAME + "::getPratica] END");
        }
	}
	...
	public CreaPraticaFruitoreResponse creaPratica(CreaPraticaFruitoreRequest pratica) throws DAOException {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            float sec = (end - start); 
            LOG.info("creaPratica() in " + sec + " milliseconds.");
            LOG.debug("[" + CLASS_NAME + "::creaPratica] END");
        }
	}
	...
	public CreaEventoFruitoreResponse creaEvento(CreaEventoFruitoreRequest evento) throws DAOException {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            float sec = (end - start); 
            LOG.info("creaEvento() in " + sec + " milliseconds.");
            LOG.debug("[" + CLASS_NAME + "::creaEvento] END");
        }
	}
	...
	public AggiornaEventoFruitoreResponse aggiornaEvento(String idEvento, AggiornaEventoFruitoreRequest evento) throws DAOException {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            float sec = (end - start); 
            LOG.info("aggiornaEvento() in " + sec + " milliseconds.");
            LOG.debug("[" + CLASS_NAME + "::aggiornaEvento] END");
        }
	}
	...
	public void eliminaEvento(String idEvento, EliminaEventoFruitoreRequest evento) throws DAOException {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            float sec = (end - start); 
            LOG.info("eliminaEvento() in " + sec + " milliseconds.");
            LOG.debug("[" + CLASS_NAME + "::eliminaEvento] END");
        }
	}
	...
	public AvviaProcessoFruitoreResponse avviaProcesso(AvviaProcessoFruitoreRequest processo) throws DAOException {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            float sec = (end - start); 
            LOG.info("avviaProcesso() in " + sec + " milliseconds.");
            LOG.debug("[" + CLASS_NAME + "::avviaProcesso] END");
        }
	}
	...
	public InviaSegnaleFruitoreResponse inviaSegnale(InviaSegnaleFruitoreRequest segnale, String idPratica) throws DAOException {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            float sec = (end - start); 
            LOG.info("inviaSegnale() in " + sec + " milliseconds.");
            LOG.debug("[" + CLASS_NAME + "::inviaSegnale] END");
        }
	}
	...
	public CreaNotificaFruitoreResponse creaNotifica(CreaNotificaFruitoreRequest notifica) throws DAOException {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            float sec = (end - start); 
            LOG.info("creaNotifica() in " + sec + " milliseconds.");
            LOG.debug("[" + CLASS_NAME + "::creaNotifica] END");
        }
	}
	...
	public FileUploadResult fileUpload(byte[] bytes, MediaType mediaType, String fileName) throws DAOException {
        ...
        try( InputStream bis = new ByteArrayInputStream(bytes) ) {
            ...
            long end = System.currentTimeMillis();
            float sec = (end - start); 
            LOG.info("fileUpload() in " + sec + " milliseconds.");
            LOG.debug("[" + CLASS_NAME + "::fileUpload] END");
        }
    }
