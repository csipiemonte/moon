...
java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\moonfobl_swagger-2.0.yaml -l jaxrs-resteasy-eap-csi -o ..\build\swagger-codegen --config swagger_config_java.json
