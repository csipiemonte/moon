 ...
 * @since 1.0.0
 */
public class UtenteEnteAbilitato {
...
//	private String password = null;
	...
	// UAR-AREA-RUOLO
	private List<EnteAreeRuoli> entiAreeRuoli = null; // per il momento list di un elemento (monoEnte), la lista potrebbe servire per multiEnte
		
	public UtenteEnteAbilitato() {
		super();
	}
...
//	}
	...
	public boolean equals(Object o) {
	    ...
	    UtenteEnteAbilitato utente = (UtenteEnteAbilitato) o;
...
//	        Objects.equals(password, utente.password) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash(idUtente, identificativoUtente, nome, cognome, /*username, password,*/ email, flagAttivo, tipoUtente, dataIns, dataUpd, attoreUpd, entiAreeRuoli);
	}
