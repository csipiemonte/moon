...
public enum DecodificaRuolo implements DecodificaMOON {
	...
	/** 11 - OP_COMP */
	OP_COMP(11, "OP_COMP", "Operatore compilazione nuove istanze", "Operatore compilazione nuove istanze"),
	/** 12 - OP_SIMPMOD */
	OP_SIMPMOD(12, "OP_SIMPMOD", "Operatore semplice con modifica", "Operatore semplice con modifica"),
	;
