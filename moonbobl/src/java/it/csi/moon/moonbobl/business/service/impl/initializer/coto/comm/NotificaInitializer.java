...
package it.csi.moon.moonbobl.business.service.impl.initializer.coto.comm;
...
public class NotificaInitializer implements DatiIstanzaInitializer {
	...
	public String getDati(AzioneInitParams initParams) throws BusinessException {
		try {
		    ...
		    RinnovoConcessioniEntity entity = RinnovoConcessioniHelper.parse(initParams.getDatiIstanza());
