...
import it.csi.moon.moonbobl.business.service.mapper.moonprint.PrintRicevutaMapper_RIC_DEM_CAMBIO_RES;
 ...
 *
 */
public class Azione_CAMBIO_RES extends Azione_Default implements AzioneService {
	
	private final static String CLASS_NAME = "Azione_CAMBIO_RES";
...
//		CambioResidenzaHelper cambioResidenzaHelper = new CambioResidenzaHelper();
		try {
			...
			documentoRicevuta = new PrintRicevutaMapper_RIC_DEM_CAMBIO_RES().remap(istanza, ricevutaEntity);
			documentoRicevuta.setTemplate("CambioResidenzaAccettata");
	...
	public void inviaRicevuta(UserInfo user, String datiAzione, Istanza istanza) throws BusinessException {
		...
		String testo = "Con riferimento alla sua istanza di richiesta di cambio residenza si allega copia della ricevuta di attestazione di cambio residenza.";
