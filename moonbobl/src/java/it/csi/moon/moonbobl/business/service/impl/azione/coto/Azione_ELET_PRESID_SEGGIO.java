 ...
 *
 */
public class Azione_ELET_PRESID_SEGGIO extends Azione_Default implements AzioneService {

	private final static String CLASS_NAME = "Azione_ELET_PRESID_SEGGIO";
	...
	public Azione_ELET_PRESID_SEGGIO() {
		super();
	...
	public void approva(UserInfo user, String datiAzione, Istanza istanza, StoricoWorkflowEntity storicoEntity) throws BusinessException {
		...
		String oggettoNotifica = "Accoglimento iscrizione Albo presidenti di seggio";
		...
		String testo ="La Sua domanda atta all'iscrizione all'Albo delle persone idonee alla funzione "
				+ "di PRESIDENTE di SEGGIO ELETTORALE è regolarmente pervenuta.\n" 
				+ "L'iscrizione all'Albo decorrerà a partire dal mese di gennaio dell'anno successivo "
				+ "alla presentazione della domanda, se inviata entro il mese di ottobre.\n"  
				+ "Si ricorda che si rimane iscritti all'Albo, fino a quando permangono i requisiti previsti dalla legge.\n\n"
	...
	public void respingiConComunicazione(UserInfo user, String datiAzione, Istanza istanza,
		...
		String oggettoNotifica = "Richiesta iscrizione Albo presidenti di seggio – ARCHIVIAZIONE";
		request.setSubject(oggettoNotifica);
		DateFormat dF = new SimpleDateFormat("dd-MM-yyyy");
		String dataInvio = dF.format(istanza.getCreated());
		String testoAggiuntivo = "";
