 ...
 *
 */
public class Azione_ELET_DISPONIBILITA extends Azione_Default implements AzioneService {
	...
	public Azione_ELET_DISPONIBILITA() {
		super();
	...
	public void approva(UserInfo user, String datiAzione, Istanza istanza, StoricoWorkflowEntity storicoEntity) throws BusinessException {
		...
		String testo =	"La Sua domanda di disponibilità è regolarmente pervenuta.\n\n" + 
				"Si informa che gli scrutatori sono nominati dalla Commissione Elettorale Comunale "
				+ "tra il 25° ed il 20° giorno antecedente la data della votazione, la stessa "
				+ "Commissione forma anche un elenco di scrutatori di riserva. In caso di nomina "
				+ "riceverà entro il 15° giorno precedente il voto la notifica tramite "
				+ "l'agente di Polizia Municipale, in caso di assenza verrà lasciato un avviso nella cassetta delle lettere. \n\n"
