...
public class NotificaDAOImpl extends JdbcTemplateDAO implements NotificaDAO {
	...
	private final static String CLASS_NAME = "NotificaDAOImpl";
	...
	private static final String INSERT = "INSERT INTO moon_fo_t_notifica(" + 
			" id_notifica, id_istanza, cf_destinatario, email_destinatario, oggetto_notifica, testo_notifica, flag_letta, flag_archiviata)" + 
			" VALUES (:id_notifica, :id_istanza, :cf_destinatario, :email_destinatario, :oggetto_notifica, :testo_notifica, :flag_letta, :flag_archiviata)";
	...
	public Long insertAllegatoNotifica(Long idNotifica, Long idFile) throws DAOException {
		try {
			log.debug("[" + CLASS_NAME + "::insertAllegatoNotifica] IN idNotifica="+idNotifica+"  idFile="+idFile);
			MapSqlParameterSource params = new MapSqlParameterSource();
	    	params.addValue("id_notifica", idNotifica);
			...
			log.debug("[" + CLASS_NAME + "::insertAllegatoNotifica] Record inseriti: " + numRecord);
			return idNotifica;
		} catch (Exception e) {
			log.error("[" + CLASS_NAME + "::insertAllegatoNotifica] Errore database: "+e.getMessage(),e);
			throw new DAOException("ERRORE INSERIMENTO");
		}
	}
}