...
public class WorkflowDAOImpl extends JdbcTemplateDAO implements WorkflowDAO {
	...
	private static final String SELECT = "SELECT id_workflow, id_processo, id_stato_wf_partenza, id_stato_wf_arrivo, campo_condizione, valore_condizione," +
			" id_azione," +
	...
	private static final String SELECT_WF_AZ = "SELECT wf.id_workflow, wf.id_processo, wf.id_stato_wf_partenza, wf.id_stato_wf_arrivo," +
			...
			" wf.flag_archiviabile, wf.flag_annullabile, wf.id_datiazione, wf.flag_stato_istanza, wf.flag_api, wf.flag_automatico, wf.id_condition";
