 ...
 *
 */
public class Azione_ELET_SCRUTATORI extends Azione_Default implements AzioneService {
	...
	public void approva(UserInfo user, String datiAzione, Istanza istanza, StoricoWorkflowEntity storicoEntity) throws BusinessException {
		...
		String oggettoNotifica = "Accoglimento richiesta iscrizione Albo scrutatori";
		...
		String testo = "La Sua domanda atta all'iscrizione all'Albo delle persone idonee alla funzione di "
				+ "SCRUTATORE di SEGGIO ELETTORALE è regolarmente pervenuta.\n" 
				+ "L'iscrizione all'Albo decorrerà a partire dal mese di gennaio dell'anno successivo "
				+ "alla presentazione della domanda, se inviata entro il mese di novembre.\n"
				+ "Si ricorda che si rimane iscritti all'Albo, fino a quando permangono i requisiti o "
				+ "se ne faccia motivata richiesta di cancellazione.\n\n" 
	...
	public void respingiConComunicazione(UserInfo user, String datiAzione, Istanza istanza,
		...
		String oggettoNotifica = "Richiesta iscrizione Albo scrutatori – ARCHIVIAZIONE";
		request.setSubject(oggettoNotifica);
		DateFormat dF = new SimpleDateFormat("dd-MM-yyyy");
		String dataInvio = dF.format(istanza.getCreated());
		String testoAggiuntivo = "";
