 ...
 * Solo un record per instanza con dataFine NULL
 * 
 * Tabella moon_fo_t_cronologia_stati
 * PK: idCronologiaStati
 * AK: idIstanza,dataFine NULL  per identificare l'ultimo stato di un istanza
 * 
 * @see IstanzaEntity
 * 
 * @author Laurent
