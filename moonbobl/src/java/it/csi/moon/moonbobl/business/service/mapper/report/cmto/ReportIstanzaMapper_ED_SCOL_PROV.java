 ...
 * 
 */
package it.csi.moon.moonbobl.business.service.mapper.report.cmto;
 ...
 * @since 1.0.0
 */
public class ReportIstanzaMapper_ED_SCOL_PROV extends ReportIstanzaMapperDefault implements ReportIstanzaMapper {
	
	private final static String CLASS_NAME = "ReportIstanzaMapper_ED_SCOL_PROV";
	...
	public String getHeader() {
		...
		sb.append("idIstanza").append(CSV_SEPARATOR);
		sb.append("codiceIstanza").append(CSV_SEPARATOR);
		sb.append("stato").append(CSV_SEPARATOR);
		sb.append("dataInvio").append(CSV_SEPARATOR);
		sb.append("codiceFiscaleDichiarante").append(CSV_SEPARATOR);
		sb.append("informativaPrivacy.dichiarazioni").append(CSV_SEPARATOR);
		sb.append("informazioniIstituto.referente.nome").append(CSV_SEPARATOR);
		sb.append("informazioniIstituto.referente.cognome").append(CSV_SEPARATOR);
		sb.append("informazioniIstituto.referente.ruolo").append(CSV_SEPARATOR);
		sb.append("informazioniIstituto.referente.ruoloSpecificare").append(CSV_SEPARATOR);
		sb.append("informazioniIstituto.referente.email").append(CSV_SEPARATOR);
		sb.append("informazioniIstituto.referente.telefono").append(CSV_SEPARATOR);
		sb.append("informazioniIstituto.referente.pec").append(CSV_SEPARATOR);
		sb.append("nomeScuola.CODICE").append(CSV_SEPARATOR);
		sb.append("nomeScuola.nome").append(CSV_SEPARATOR);
		sb.append("nomeScuola.sede").append(CSV_SEPARATOR);
		sb.append("nomDirigenteScolastico").append(CSV_SEPARATOR);
		sb.append("nomeDsga").append(CSV_SEPARATOR);
		sb.append("nomeDelRspp").append(CSV_SEPARATOR);
		return sb.toString();
