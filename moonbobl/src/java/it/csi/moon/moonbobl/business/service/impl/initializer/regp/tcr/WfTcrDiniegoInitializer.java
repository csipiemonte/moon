...
public class WfTcrDiniegoInitializer implements DatiIstanzaInitializer {
	...
	private final static String CLASS_NAME = "WfTcrDiniegoInitializer";
	private Logger log = LoggerAccessor.getLoggerBusiness();
	

	public WfTcrDiniegoInitializer () {
		super();
	...
	public String getDati(AzioneInitParams initParams) throws BusinessException {
		try {
		    ...
		    g.writeStringField("numeroAccertamento",entity.getNumeroDomanda());
		    g.writeStringField("annoDiPagamento", entity.getAnnoRiferimento());
		    
		    g.writeEndObject(); // } end of data
		    g.close();
		    
		    //log.info("[" + CLASS_NAME + "::getDati] start"+ g.toString());
