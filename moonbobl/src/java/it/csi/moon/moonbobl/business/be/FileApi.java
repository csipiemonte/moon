...
public interface FileApi  {
    ...
    public Response uploadFile(@QueryParam("baseUrl") String baseUrl, @PathParam("form") String form, @PathParam("project") String project,
    	@QueryParam("filter") String filter, @QueryParam("err-msg") String errMsg, MultipartFormDataInput input, 
    ...
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    @Produces({"application/json;charset=UTF-8"})
    public Response uploadFileNotifica(@QueryParam("baseUrl") String baseUrl, @PathParam("form") String form, @PathParam("project") String project,     	
    	MultipartFormDataInput input,@QueryParam("idTipoMydocs") String idTipoMydocs,
    	@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest ) throws FileUploadException;
    ...
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
	public Response getFileNotificaFruitore(@QueryParam("baseUrl") String refUrl, @QueryParam("form") String nomeFile, 
		@QueryParam("idIstanza") Long idIstanza, @QueryParam("idStoricoWorkflow") Long idStoricoWorkflow, 
	    @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest);
    ...
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    @Produces({"application/json;charset=UTF-8"})
    public Response uploadRepositoryFile(@QueryParam("baseUrl") String baseUrl, @PathParam("form") String form, @PathParam("project") String project, 
    	MultipartFormDataInput input, @PathParam("idTipologia") String idTipologiaPP, @QueryParam("idTipoMydocs") String idTipoMydocs,
    	@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest ) throws UnprocessableEntityException, FileUploadException;
