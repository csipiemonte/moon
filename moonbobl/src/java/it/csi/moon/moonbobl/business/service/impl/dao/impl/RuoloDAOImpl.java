...
public class RuoloDAOImpl extends JdbcTemplateDAO implements RuoloDAO {
	...
	private final static String CLASS_NAME = "RuoloDAOImpl";
	...
	private static final  String FIND_ENTE_AREA_RUOLO_ATTIVI_BY_ID_UTENTE_PORTALE  = "select e.id_ente, e.codice_ente, e.nome_ente, e.descrizione_ente, e.id_tipo_ente, a.id_area, a.codice_area, a.nome_area, r.id_ruolo, r.codice_ruolo, r.nome_ruolo" + 
			" FROM moon_fo_r_utente_area_ruolo uar, moon_fo_d_area a, moon_fo_d_ente e, moon_fo_d_ruolo r, moon_fo_r_portale_ente pe, moon_fo_d_portale p" + 
			" WHERE uar.id_utente = :id_utente" + 
			" AND a.id_area = uar.id_area" + 
			" AND e.id_ente = a.id_ente" + 
			" AND e.fl_attivo = 'S'" + 
			" AND r.id_ruolo = uar.id_ruolo" + 
			" AND r.fl_attivo = 'S'" +
			" AND e.id_ente = pe.id_ente" +
			" AND p.id_portale=pe.id_portale" +
			" AND p.nome_portale = :nome_portale" +
			" ORDER BY e.id_tipo_ente, e.descrizione_ente, a.nome_area, r.nome_ruolo";
	private static final  String FIND_ENTE_AREA_RUOLO_ATTIVI_BY_UTENTE_ID_ENTE  = "select e.id_ente, e.codice_ente, e.nome_ente, e.descrizione_ente, e.id_tipo_ente, a.id_area, a.codice_area, a.nome_area, r.id_ruolo, r.codice_ruolo, r.nome_ruolo" + 
			" FROM moon_fo_t_utente u, moon_fo_r_utente_area_ruolo uar, moon_fo_d_area a, moon_fo_d_ente e, moon_fo_d_ruolo r" + 
			" WHERE u.identificativo_utente = :identificativo_utente" + 
			" AND uar.id_utente = u.id_utente" +
			" AND a.id_area = uar.id_area" + 
			" AND a.id_ente = :id_ente" +
			" AND e.id_ente = a.id_ente" + 
			" AND e.fl_attivo = 'S'" + 
			" AND r.id_ruolo = uar.id_ruolo" + 
			" AND r.fl_attivo = 'S'" +
	...
	public List<EnteAreaRuoloFlatDTO> findEntiAreaRuoliAttiviByIdUtentePortale(Long idUtente, String nomePortale) throws DAOException {
		try {
			...
			return (List<EnteAreaRuoloFlatDTO>)getCustomNamedParameterJdbcTemplateImpl().query(FIND_ENTE_AREA_RUOLO_ATTIVI_BY_ID_UTENTE_PORTALE, params, new RowMapper<EnteAreaRuoloFlatDTO>() {
				@Override
				public EnteAreaRuoloFlatDTO mapRow(ResultSet rs, int rownumber) throws SQLException {
					// e.id_ente, e.codice_ente, e.nome_ente, e.descrizione_ente, e.id_tipo_ente, a.id_area, a.codice_area, a.nome_area, r.id_ruolo, r.codice_ruolo, r.nome_ruolo
					EnteAreaRuoloFlatDTO e = new EnteAreaRuoloFlatDTO();
			...
			log.error("[" + CLASS_NAME + "::findEntiAreaRuoliAttiviByIdUtente] Elemento non trovato: "+emptyEx.getMessage(),emptyEx);
			throw new ItemNotFoundDAOException();
		} catch (Exception e) {
			log.error("[" + CLASS_NAME + "::findEntiAreaRuoliAttiviByIdUtente] Errore database: "+e.getMessage(),e);
			throw new DAOException(getMsgErrDefault());
		}
	}
	public List<EnteAreaRuoloFlatDTO> findEntiAreaRuoliAttiviByUtenteIdEnte(String identificativoUtente, Long idEnte) throws DAOException {
		try {
			log.debug("[" + CLASS_NAME + "::findEntiAreaRuoliAttiviByUtenteIdEnte] IN utente: " + identificativoUtente + "  idEnte:" + idEnte);
			MapSqlParameterSource params = new MapSqlParameterSource();
			params.addValue("identificativo_utente", identificativoUtente);
			params.addValue("id_ente", idEnte);
			return (List<EnteAreaRuoloFlatDTO>)getCustomNamedParameterJdbcTemplateImpl().query(FIND_ENTE_AREA_RUOLO_ATTIVI_BY_UTENTE_ID_ENTE, params, new RowMapper<EnteAreaRuoloFlatDTO>() {
				@Override
				public EnteAreaRuoloFlatDTO mapRow(ResultSet rs, int rownumber) throws SQLException {
					// e.id_ente, e.codice_ente, e.nome_ente, e.descrizione_ente, e.id_tipo_ente, a.id_area, a.codice_area, a.nome_area, r.id_ruolo, r.codice_ruolo, r.nome_ruolo
					EnteAreaRuoloFlatDTO e = new EnteAreaRuoloFlatDTO();
			...
			log.error("[" + CLASS_NAME + "::findEntiAreaRuoliAttiviByUtenteIdEnte] Elemento non trovato: "+emptyEx.getMessage(),emptyEx);
			throw new ItemNotFoundDAOException();
		} catch (Exception e) {
			log.error("[" + CLASS_NAME + "::findEntiAreaRuoliAttiviByUtenteIdEnte] Errore database: "+e.getMessage(),e);
			throw new DAOException(getMsgErrDefault());
		}
	}
