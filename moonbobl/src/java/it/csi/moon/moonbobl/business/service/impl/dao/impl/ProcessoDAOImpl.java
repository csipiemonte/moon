...
public class ProcessoDAOImpl extends JdbcTemplateDAO implements ProcessoDAO {
	...
	private static final String FIND_SELECT_FIELDS = "SELECT id_processo, codice_processo, nome_processo, descrizione_processo, fl_attivo AS flag_attivo, data_upd, attore_upd";
	...
	private static final String INSERT = "INSERT INTO moon_wf_d_processo(" +
		" id_processo, codice_processo, nome_processo, descrizione_processo, fl_attivo, data_upd, attore_upd)" + 
