...
package it.csi.moon.moonbobl.business.be.extra.territorio;
...
@Path("/be/extra/territorio/toponomastica")
@Produces({ "application/json" })
@io.swagger.annotations.Api(description = "the toponomastica API")
...
public interface ToponomasticaApi {
    ...
    public Response getVie( @QueryParam("limit") int limit, @QueryParam("skip") int skip, @QueryParam("fields") String fields, 
    ...
    @io.swagger.annotations.ApiResponses(value = { 
	    ...
	    @io.swagger.annotations.ApiResponse(code = 200, message = "errore generico", response = Error.class) })
    public Response getCiviciByVia( @PathParam("codiceVia") String codiceVia, @QueryParam("tipologieCivico") String tipologieCivico, @QueryParam("fields") String fields,
    	@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest ) throws UnprocessableEntityException, ResourceNotFoundException;
    ...
    @io.swagger.annotations.ApiResponses(value = { 
	    @io.swagger.annotations.ApiResponse(code = 200, message = "elenco civici", response = Civico.class, responseContainer = "List"),
	    @io.swagger.annotations.ApiResponse(code = 200, message = "errore generico", response = Error.class) })
    public Response getCiviciByViaNumero( @PathParam("codiceVia") String codiceVia, @PathParam("numero") String numero, @QueryParam("tipologieCivico") String tipologieCivico, @QueryParam("fields") String fields,
    	@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest ) throws UnprocessableEntityException, ResourceNotFoundException;
